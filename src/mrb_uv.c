...
static mrb_value mrb_uv_gc(mrb_state *mrb, mrb_value self)
{
  return mrb_uv_gc_table_clean(mrb), self;
}

static mrb_value mrb_uv_run(mrb_state *mrb, mrb_value self)
{
 ...
 * UV::Req
 */
static void mrb_uv_req_free(mrb_state *mrb, void *p)
{
  if (p) {
...
static mrb_value mrb_uv_cancel(mrb_state *mrb, mrb_value self)
{
  mrb_uv_check_error(mrb, uv_cancel(&((mrb_uv_req_t *)mrb_uv_get_ptr(mrb, self, &req_type))->req));
  return self;
}

static mrb_value mrb_uv_req_type(mrb_state *mrb, mrb_value self)
{
  mrb_uv_req_t *req;
 ...
 * UV::Loop
 *********************************************************/
static void mrb_uv_loop_free(mrb_state *mrb, void *p)
{
...
const struct mrb_data_type mrb_uv_loop_type = {"uv_loop", mrb_uv_loop_free};

static mrb_value mrb_uv_default_loop(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_loop_init(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_loop_run(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_loop_close(mrb_state *mrb, mrb_value self)
{
  uv_loop_t *loop = (uv_loop_t *)mrb_uv_get_ptr(mrb, self, &mrb_uv_loop_type);
...
static mrb_value mrb_uv_loop_alive(mrb_state *mrb, mrb_value self)
{
  uv_loop_t *loop = (uv_loop_t *)mrb_uv_get_ptr(mrb, self, &mrb_uv_loop_type);
  return mrb_bool_value(uv_loop_alive(loop));
}

static mrb_value mrb_uv_stop(mrb_state *mrb, mrb_value self)
{
  uv_loop_t *loop = (uv_loop_t *)mrb_uv_get_ptr(mrb, self, &mrb_uv_loop_type);
  return uv_stop(loop), self;
}

static mrb_value mrb_uv_update_time(mrb_state *mrb, mrb_value self)
{
  uv_loop_t *loop = (uv_loop_t *)mrb_uv_get_ptr(mrb, self, &mrb_uv_loop_type);
  return uv_update_time(loop), self;
}

static mrb_value mrb_uv_backend_fd(mrb_state *mrb, mrb_value self)
{
  uv_loop_t *loop = (uv_loop_t *)mrb_uv_get_ptr(mrb, self, &mrb_uv_loop_type);
  return mrb_fixnum_value(uv_backend_fd(loop));
}

static mrb_value mrb_uv_backend_timeout(mrb_state *mrb, mrb_value self)
{
  uv_loop_t *loop = (uv_loop_t *)mrb_uv_get_ptr(mrb, self, &mrb_uv_loop_type);
  return mrb_fixnum_value(uv_backend_timeout(loop));
}

static mrb_value mrb_uv_now(mrb_state *mrb, mrb_value self)
{
  uv_loop_t *loop;
...
static mrb_value mrb_uv_loadavg(mrb_state *mrb, mrb_value self)
{
 ...
 * UV::Ip4Addr
 *********************************************************/
static void uv_ip4addr_free(mrb_state *mrb, void *p)
{
  mrb_free(mrb, p);
}
...
static mrb_value mrb_uv_ip4_addr(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_ip4addr_init(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_ip4addr_to_s(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_ip4addr_sin_addr(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_ip4addr_sin_port(mrb_state *mrb, mrb_value self)
{
  struct sockaddr_in *addr = NULL;
  Data_Get_Struct(mrb, self, &mrb_uv_ip4addr_type, addr);
 ...
 * UV::Ip6Addr
 *********************************************************/
static void uv_ip6addr_free(mrb_state *mrb, void *p)
{
  mrb_free(mrb, p);
}
...
static mrb_value mrb_uv_ip6_addr(mrb_state *mrb, mrb_value self)
{
  mrb_uv_args_int argc;
  mrb_value *argv;
  struct RClass *_class_uv;
...
static mrb_value mrb_uv_ip6addr_init(mrb_state *mrb, mrb_value self)
{
  mrb_value arg_host = mrb_nil_value(), arg_port = mrb_nil_value();
...
static mrb_value mrb_uv_ip6addr_to_s(mrb_state *mrb, mrb_value self)
{
  mrb_value str = mrb_funcall(mrb, self, "sin_addr", 0);
  mrb_str_cat2(mrb, str, ":");
  mrb_str_concat(mrb, str, mrb_funcall(mrb, self, "sin_port", 0));
...
static mrb_value mrb_uv_ip6addr_sin_addr(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_ip6addr_sin_port(mrb_state *mrb, mrb_value self)
{
  struct sockaddr_in6 *addr = NULL;
  Data_Get_Struct(mrb, self, &mrb_uv_ip6addr_type, addr);
 ...
 * UV.getnameinfo
 */
static void mrb_uv_getnameinfo_cb(uv_getnameinfo_t *req, int status, char const *host, char const *service)
{
...
static mrb_value mrb_uv_getnameinfo(mrb_state *mrb, mrb_value self)
{
  ...
  mrb_uv_check_error(
      mrb, uv_getnameinfo(uv_default_loop(), (uv_getnameinfo_t *)&req->req, mrb_uv_getnameinfo_cb, addr, flags));
  return req_val;
}
 ...
 * UV::Addrinfo
 *********************************************************/
static void uv_addrinfo_free(mrb_state *mrb, void *p)
{
...
static void _uv_getaddrinfo_cb(uv_getaddrinfo_t *req, int status, struct addrinfo *res)
{
  mrb_value args[2];
...
static mrb_value mrb_uv_getaddrinfo(mrb_state *mrb, mrb_value self)
{
  ...
  req = (mrb_uv_req_t *)DATA_PTR(req_val);
  mrb_uv_check_error(mrb, uv_getaddrinfo(uv_default_loop(), (uv_getaddrinfo_t *)&req->req, _uv_getaddrinfo_cb,
                                         RSTRING_PTR(node), RSTRING_PTR(service), &hints));
  return req_val;
}

static mrb_value mrb_uv_addrinfo_flags(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_uv_addrinfo_family(mrb_state *mrb, mrb_value self)
{
  struct addrinfo *addr = NULL;
  Data_Get_Struct(mrb, self, &uv_addrinfo_type, addr);
...
static mrb_value mrb_uv_addrinfo_socktype(mrb_state *mrb, mrb_value self)
{
  struct addrinfo *addr = NULL;
  Data_Get_Struct(mrb, self, &uv_addrinfo_type, addr);
...
static mrb_value mrb_uv_addrinfo_protocol(mrb_state *mrb, mrb_value self)
{
  struct addrinfo *addr = NULL;
  Data_Get_Struct(mrb, self, &uv_addrinfo_type, addr);
...
static mrb_value mrb_uv_addrinfo_addr(mrb_state *mrb, mrb_value self)
{
  struct addrinfo *addr = NULL;
  struct RClass *_class_uv;
  mrb_value c = mrb_nil_value();
  ...
  case AF_INET: {
    ...
    *saddr = *(struct sockaddr_in *)addr->ai_addr;
    args[0] = mrb_obj_value(Data_Wrap_Struct(mrb, mrb->object_class, &mrb_uv_ip4addr_type, (void *)saddr));
  ...
  case AF_INET6: {
    ...
    *saddr = *(struct sockaddr_in6 *)addr->ai_addr;
    args[0] = mrb_obj_value(Data_Wrap_Struct(mrb, mrb->object_class, &mrb_uv_ip6addr_type, (void *)saddr));
...
static mrb_value mrb_uv_addrinfo_canonname(mrb_state *mrb, mrb_value self)
{
  struct addrinfo *addr = NULL;
  Data_Get_Struct(mrb, self, &uv_addrinfo_type, addr);
  return mrb_str_new_cstr(mrb, addr->ai_canonname ? addr->ai_canonname : "");
}

static mrb_value mrb_uv_addrinfo_next(mrb_state *mrb, mrb_value self)
{
  struct addrinfo *addr = NULL;
  Data_Get_Struct(mrb, self, &uv_addrinfo_type, addr);
...
static mrb_value mrb_uv_guess_handle(mrb_state *mrb, mrb_value self)
{
  mrb_int fd;
  uv_handle_type h;
  ...
  switch (h) {
  case UV_FILE:
    return symbol_value_lit(mrb, "file");
...
static mrb_value mrb_uv_exepath(mrb_state *mrb, mrb_value self)
{
  char buf[PATH_MAX];
  size_t s = sizeof(buf);
...
static mrb_value mrb_uv_cwd(mrb_state *mrb, mrb_value self)
{
  char buf[PATH_MAX];
  size_t s = sizeof(buf);
...
static mrb_value mrb_uv_chdir(mrb_state *mrb, mrb_value self)
{
  char *z;
...
static mrb_value mrb_uv_kill(mrb_state *mrb, mrb_value self)
{
  mrb_int pid, sig;
...
static mrb_value mrb_uv_version(mrb_state *mrb, mrb_value self)
{
  return mrb_fixnum_value(uv_version());
}

static mrb_value mrb_uv_version_string(mrb_state *mrb, mrb_value self)
{
  return mrb_str_new_cstr(mrb, uv_version_string());
}

void *mrb_uv_get_ptr(mrb_state *mrb, mrb_value v, struct mrb_data_type const *t)
{
...
static mrb_value mrb_uv_free_memory(mrb_state *mrb, mrb_value self)
{
  return mrb_uv_from_uint64(mrb, uv_get_free_memory());
}

static mrb_value mrb_uv_total_memory(mrb_state *mrb, mrb_value self)
{
  return mrb_uv_from_uint64(mrb, uv_get_total_memory());
}

static mrb_value mrb_uv_hrtime(mrb_state *mrb, mrb_value self)
{
  return mrb_uv_from_uint64(mrb, uv_hrtime());
}

static mrb_value mrb_uv_disable_stdio_inheritance(mrb_state *mrb, mrb_value self)
{
  return uv_disable_stdio_inheritance(), self;
}

static mrb_value mrb_uv_process_title(mrb_state *mrb, mrb_value self)
{
  char buf[PATH_MAX];
...
static mrb_value mrb_uv_process_title_set(mrb_state *mrb, mrb_value self)
{
  char *z;
  mrb_get_args(mrb, "z", &z);
...
static mrb_value mrb_uv_rusage(mrb_state *mrb, mrb_value self)
{
  uv_rusage_t usage;
  mrb_value ret, tv;
...
#define set_val(name) mrb_hash_set(mrb, ret, symbol_value_lit(mrb, #name), mrb_uv_from_uint64(mrb, usage.ru_##name))
...
static mrb_value mrb_uv_cpu_info(mrb_state *mrb, mrb_value self)
{
  uv_cpu_info_t *info;
...
static mrb_value mrb_uv_interface_addresses(mrb_state *mrb, mrb_value self)
{
...
static void mrb_uv_work_cb(uv_work_t *uv_req)
{
...
static void mrb_uv_after_work_cb(uv_work_t *uv_req, int err)
{
  mrb_uv_req_t *req = (mrb_uv_req_t *)uv_req->data;
  mrb_state *mrb = req->mrb;
...
static mrb_value mrb_uv_queue_work(mrb_state *mrb, mrb_value self)
{
  mrb_value cfunc, blk = mrb_nil_value(), req_val;
  mrb_uv_req_t *req;
  ...
  mrb_uv_check_error(mrb,
                     uv_queue_work(uv_default_loop(), (uv_work_t *)&req->req, mrb_uv_work_cb, mrb_uv_after_work_cb));
  return req_val;
}

static mrb_value mrb_uv_resident_set_memory(mrb_state *mrb, mrb_value self)
{
  size_t rss;
...
static mrb_value mrb_uv_uptime(mrb_state *mrb, mrb_value self)
{
  double t;
...
void mrb_mruby_uv_gem_init(mrb_state *mrb)
{
  ...
  mrb_define_module_function(mrb, _class_uv, "disable_stdio_inheritance", mrb_uv_disable_stdio_inheritance,
                             MRB_ARGS_NONE());
